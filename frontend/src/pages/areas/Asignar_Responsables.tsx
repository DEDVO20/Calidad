        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-[#ECFDF5] border border-[#E5E7EB] shadow-sm">
            <CardHeader>
              ...
              <div className="text-4xl font-bold text-[#1E3A8A] mt-4">{areasConResponsable}</div>
            </CardHeader>
          </Card>
                  ...
                  {filteredAsignaciones.length === 0 ? (
                    ...
                    filteredAsignaciones.map((asignacion) => (
                      <tr key={asignacion.id} className="hover:bg-[#EFF6FF] transition-colors">
                        ...
                        <td className="p-6 text-[#6B7280]">{asignacion.usuario.email}</td>
                        <td className="p-6">
            ...
            {dialogMode === "create" ? (
              <>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <Label htmlFor="principal" className="cursor-pointer font-medium">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#ECFDF5] rounded-xl p-6 border border-[#E5E7EB]">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#6B7280]">{selectedAsignacion.usuario.email}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-center">
                  {selectedAsignacion.esPrincipal ? (
                    <Badge className="text-base px-5 py-2 bg-[#ECFDF5] text-[#22C55E]">
                      <ShieldCheck className="h-4 w-4 mr-1" /> Responsable Principal
                    </Badge>
                  ) : (
