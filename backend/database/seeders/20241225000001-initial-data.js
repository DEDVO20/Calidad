...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.bulkInsert('documentos', [
        {
          ...
          codigo: 'DOC-CAL-001',
          nombre: 'Manual de Calidad ISO 9001:2015',
          descripcion: 'Manual del Sistema de Gestión de Calidad ISO 9001',
          nombre_archivo: 'Manual_de_Calidad_v2.0.pdf',
          ruta_archivo: '/documentos/manuales/manual_calidad_v2.pdf',
          ...
          fecha_vigencia: new Date('2025-01-01'),
        ...
        },
        {
          ...
          descripcion: 'Procedimiento para control de documentos del SGC',
          nombre_archivo: 'Procedimiento_Control_Documentos_v1.5.pdf',
          ruta_archivo: '/documentos/procedimientos/proc_control_docs_v1.5.pdf',
        ...
        },
        {
          ...
          codigo: 'INST-OPE-001',
          nombre: 'Instructivo de Operación de Equipos',
          descripcion: 'Instructivo para operación segura de equipos',
          nombre_archivo: 'Instructivo_Operacion_Equipos_v1.0.pdf',
          ruta_archivo: '/documentos/instructivos/inst_operacion_v1.pdf',
      ...
      await queryInterface.bulkInsert('control_riesgos', [
        {
          id: uuidv4(),
      ...
      await queryInterface.bulkInsert('capacitaciones', [
        {
          ...
          objetivo: 'Conocer los requisitos y fundamentos de la norma ISO 9001:2015',
          contenido: 'Introducción a SGC, Requisitos ISO 9001, Enfoque a procesos',
          responsable_id: adminUserId,
          estado: 'realizada',
          creado_en: new Date(),
          actualizado_en: new Date(),
        },
        {
          ...
          lugar: 'Sala de Capacitación - Sede Principal',
          objetivo: 'Formar auditores internos competentes en ISO 9001',
          contenido: 'Técnicas de auditoría, Elaboración de informes, Seguimiento de hallazgos',
          responsable_id: adminUserId,
          estado: 'programada',
          creado_en: new Date(),
          actualizado_en: new Date(),
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.bulkDelete('control_riesgos', null, { transaction });
