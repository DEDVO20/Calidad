...
export const createRiesgo = async (req: Request, res: Response) => {
  try {
    ...
    if (existe) {
      return res
        .status(409)
        .json({ message: "Ya existe un riesgo con ese código." });
    }
    ...
    return res
      .status(500)
      .json({ message: "Error al crear el riesgo", error: error.message });
  }
};
...
export const getRiesgos = async (_req: Request, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error al obtener riesgos", error: error.message });
  }
};
...
export const getRiesgoById = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error al obtener el riesgo", error: error.message });
  }
};
...
export const updateRiesgo = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error al actualizar el riesgo", error: error.message });
  }
};
...
export const deleteRiesgo = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error al eliminar el riesgo", error: error.message });
  }
};
